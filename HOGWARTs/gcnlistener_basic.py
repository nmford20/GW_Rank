...
def process_gcn(payload, root):
    ...
    print("extracted skymap parameters")
    ...
    print("Read GLADEV2 catalog and get all galaxy coordinates")
    ...
    #setting folder name for saving analysis outputs
    outputdir = "output"
    ...
    for d in range(0,len(contours)):
        ...
        createasciifile(jsonlist2,graceid,prelim,levelsper,d,outputdir)

        print("saved galaxies list as ascii file")
  
          
payload = open('../skymaps/S190814bv-1-Preliminary.xml', 'rb').read()
